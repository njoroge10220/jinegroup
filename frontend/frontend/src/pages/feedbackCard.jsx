...
function FeedbackCard({title, occupation, feedback, rating}){
    return(
        <div>
            <div className="bg-[#aaabab] rounded-lg md:w-[70%] w-[90%] mx-auto flex flex-col px-2 ">                    
                ...
                <div className="flex justify-center items-center px-3 mx-auto">
                    <p className="py-4 flex justify-center items-center  px-1 mx-auto">
                        {feedback}  
                    </p>
                </div>
